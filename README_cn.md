...
此repository是基于[PaddleDetection](https://github.com/PaddlePaddle/PaddleDetection)的`YOLOX`，其upstream为PaddleDetection的[develop](https://github.com/PaddlePaddle/PaddleDetection/tree/develop)分支，在保持与PaddleDetection同步更新的同时，也更新关于YOLOX的一些改进，欢迎一起使用和建设！
